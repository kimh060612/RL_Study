...
class GraphicDisplay(tk.Tk):
    ...
    def load_images(self):
        up = PhotoImage(Image.open("D:\\RL_Study\\img\\up.png").resize((13, 13)))
        right = PhotoImage(Image.open("D:\\RL_Study\\img\\right.png").resize((13, 13)))
        left = PhotoImage(Image.open("D:\\RL_Study\\img\\left.png").resize((13, 13)))
        down = PhotoImage(Image.open("D:\\RL_Study\\img\\down.png").resize((13, 13)))
        rectangle = PhotoImage(Image.open("D:\\RL_Study\\img\\rectangle.png").resize((65, 65)))
        triangle = PhotoImage(Image.open("D:\\RL_Study\\img\\triangle.png").resize((65, 65)))
        circle = PhotoImage(Image.open("D:\\RL_Study\\img\\circle.png").resize((65, 65)))
